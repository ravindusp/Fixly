defmodule Fixly.Accounts.User do
  use Ecto.Schema
  ...
  @roles ~w(super_admin org_admin contractor_admin technician resident)
  ...
  """
  def valid_password?(%Fixly.Accounts.User{hashed_password: hashed_password}, password)
